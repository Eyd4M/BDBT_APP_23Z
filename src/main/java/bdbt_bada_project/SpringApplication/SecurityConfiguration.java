...
//                .and()
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/main", "/new", "/edit/**", "/delete/**", "/new_p", "/edit_p/**", "/delete_p/**", "/update", "/update_p", "/update_k").authenticated()
                ...
                .antMatchers("/main_user","/edit_k/**", "/update_k").access("hasRole('USER')")
