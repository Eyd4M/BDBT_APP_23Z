...
//                .and()
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/main", "/new", "/edit/**", "/delete/**", "/new_p", "/edit_p/**", "/delete_p/**").authenticated()
                .antMatchers("/animals_admin", "/new", "/edit/**", "/delete/**", "/edit_p/**", "/delete_p/**", "/new_p").access("hasRole('ADMIN')")
